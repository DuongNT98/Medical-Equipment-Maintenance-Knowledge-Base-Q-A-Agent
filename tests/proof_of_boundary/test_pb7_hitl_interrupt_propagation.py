...
#
# Two test cases (framework Proof-of-Boundary spec, PB-7):
#
...
#
# References:
#   Proof-of-Boundary spec PB-7
#   HITL Compliance (D6 pattern, hitl_allowed guard)
#   framework production-readiness criteria — hitl_allowed guard
...
def test_pb7_hitl_interrupt_propagates() -> None:
    ...
    Covers the framework's Proof-of-Boundary spec, PB-7 (first assertion):
...
def test_pb7_hitl_allowed_false_skips_interrupt() -> None:
    ...
    Covers HITL Compliance + the framework's hitl_allowed guard criterion:
